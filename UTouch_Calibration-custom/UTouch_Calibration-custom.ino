...
void readCoordinates()
{
  ...
  while (OK == false)
  {
    ...
    while ((myTouch.dataAvailable() == true) && (cnt<iter) && (failcount<10000))
    {
      ...
      String serialOut="12345678901";
      myGLCD.setColor(VGA_BLACK);
      myGLCD.setBackColor(VGA_BLACK);
      myGLCD.print(serialOut,CENTER,text_y_center+20);
      myGLCD.print(serialOut,CENTER,text_y_center+20+12);
      myGLCD.setBackColor(VGA_RED);

      myGLCD.setColor(VGA_WHITE);
      serialOut=String(myTouch.TP_X)+","+String(myTouch.TP_Y);
      myGLCD.print(serialOut,CENTER,text_y_center+20);
      serialOut=String(cnt)+","+String(failcount);
      myGLCD.print(serialOut,CENTER,text_y_center+20+12);
